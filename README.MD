...
├── model_v5s.pt                          # pt file goes in model folder
├── model_v5sv5480480Half.onnx            # onnx file goes in model folder
├── model_fn_v5v5320320Half.onnx          # onnx file goes in model folder
